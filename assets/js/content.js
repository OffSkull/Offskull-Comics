window.OFFSKULL_DATA = {
  ...
  authorText: "Дмитрий Черепов — автор и создатель проекта OffSkull Comics. Он придумывает оригинальные вселенные, необычных героев и истории, в которых супергероика, фантастика, приключения и юмор соединяются в единый авторский мир."
},
  },
