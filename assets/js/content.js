window.OFFSKULL_DATA = {
  "site": {
    ...
    "authorText": "Автор и создатель проекта OffSkull Comics. Здесь публикуются оригинальные комиксы, персонажи и истории в жанрах супергероики, приключений, мистики и чёрного юмора."
  },
  "comics": [
    {
      "id": "otshchipentsy",
  ...
  "characters": [
    ...
    },
    {
      "name": "Лор Недодел",
      "age": "26",
      "ability": "Искажение реальности, лучи незавершённости, подавление способностей, создание недоделанных ловушек.",
      "description": "Способен превращать любое действие, механизм или способность в нечто незаконченное. Под влиянием его красного осколка герои не могут договорить фразы, завершить атаку или правильно использовать свои силы. Он холоден, язвителен и уверен, что любое великое дело можно разрушить, если остановить его за мгновение до конца.",
      "image": "assets/images/characters/lor-nedodel-1785134041851.png"
    }
  ]
};
